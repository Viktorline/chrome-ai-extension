...
export function TrashIcon(props: IconsProps) {
  return (
    <svg width='800px' height='800px' viewBox='0 0 394.299 394.299' {...props}>
      <g>
        <path
          d='M345.738,56.108h-80.183V29.735C265.556,13.343,252.213,0,235.82,0h-77.354c-16.393,0-29.724,13.343-29.724,29.735v26.373
